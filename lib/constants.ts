export const RESPONSIBILITY_OPTIONS = {
  "Compliance & AML": [
    ...
    "KYC/CDD client onboarding and due diligence",
  ...
  "Data & Technology": [
    ...
    "AI solution design for compliance processes",
...
export const SKILL_OPTIONS = {
  ...
  "Technical & Data Skills": [
    ...
    "Excel and advanced analytics",
    "AML software systems (Actimize, SAS, FICO)",
